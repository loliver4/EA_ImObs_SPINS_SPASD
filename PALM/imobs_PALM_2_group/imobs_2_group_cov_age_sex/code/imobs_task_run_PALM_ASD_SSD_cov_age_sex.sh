...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/imobs_PALM_2_group/imobs_2_group_cov_age_sex/PALM_logs/PALM_ASD_SSD_imobs_task_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/imobs_PALM_2_group/imobs_2_group_cov_age_sex/PALM_logs/PALM_ASD_SSD_imobs_task_cov_age_sex%jerr.txt
#SBATCH --array=1
...
sublistids="${DIR}/subids/ASD_SSD_sublist_imobs.txt"
...
desmat="$DIR/con_design/ASD_SSD_imobs_task_design_cov_age_sex.csv"
