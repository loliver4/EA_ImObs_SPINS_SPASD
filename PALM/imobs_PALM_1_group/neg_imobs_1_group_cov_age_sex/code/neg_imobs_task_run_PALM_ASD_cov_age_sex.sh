...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/imobs_PALM_1_group/neg_imobs_1_group_cov_age_sex/PALM_logs/PALM_ASD_neg_imobs_task_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/imobs_PALM_1_group/neg_imobs_1_group_cov_age_sex/PALM_logs/PALM_ASD_neg_imobs_task_cov_age_sex%jerr.txt
#SBATCH --array=1
