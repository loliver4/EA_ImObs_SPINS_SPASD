...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/imobs_PALM_transdiag/imobs_transdiag_simulation_cov_age_sex/PALM_logs/PALM_transdiag_imobs_task_simulation_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/imobs_PALM_transdiag/imobs_transdiag_simulation_cov_age_sex/PALM_logs/PALM_transdiag_imobs_task_simulation_cov_age_sex%jerr.txt
#SBATCH --array=1
...
DIR="/projects/imoxonemre/SPIN_ASD/imobs_PALM_transdiag/imobs_transdiag_simulation_cov_age_sex"
...
desmat="$DIR/con_design/transdiag_imobs_task_design_fscore_simulation_cov_age_sex.csv"
conmat="$DIR/con_design/1_group_imobs_task_contrast_simulation_cov_age_sex.csv"
...
runpalm() {
    ...
    # C1 = positive slope; C2 = negative slope; C3 = positive simulation; c4 = negative simulation; C5 = positive age; C6 = negative age; C7 = positive sex; C8 = negative sex
