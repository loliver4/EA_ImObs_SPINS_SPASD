...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/neg_ea_2_group_pmod_cov_age_sex/PALM_logs/PALM_ASD_TDC_neg_ea_task_pmod_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/neg_ea_2_group_pmod_cov_age_sex/PALM_logs/PALM_ASD_TDC_neg_ea_task_pmod_cov_age_sex%jerr.txt
#SBATCH --array=1
