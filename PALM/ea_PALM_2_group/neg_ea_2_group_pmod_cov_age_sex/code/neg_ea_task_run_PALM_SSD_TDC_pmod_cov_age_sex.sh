...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/neg_ea_2_group_pmod_cov_age_sex/PALM_logs/PALM_SSD_TDC_neg_ea_task_pmod_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/neg_ea_2_group_pmod_cov_age_sex/PALM_logs/PALM_SSD_TDC_neg_ea_task_pmod_cov_age_sex%jerr.txt
#SBATCH --array=1
...
# assign the current directory variable and paths to the filielist and sublist for this 2 group analysis (SSD vs. TDC)

DIR="/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/neg_ea_2_group_pmod_cov_age_sex"

sublistids="${DIR}/subids/SSD_TDC_sublist_ea.txt"
...
desmat="$DIR/con_design/SSD_TDC_ea_ea_task_design_cov_age_sex.csv"
