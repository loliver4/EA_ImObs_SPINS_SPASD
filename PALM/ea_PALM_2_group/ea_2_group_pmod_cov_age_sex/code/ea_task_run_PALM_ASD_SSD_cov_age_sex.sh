...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/ea_2_group_pmod_cov_age_sex/PALM_logs/PALM_ASD_SSD_ea_task_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/ea_2_group_pmod_cov_age_sex/PALM_logs/PALM_ASD_SSD_ea_task_cov_age_sex%jerr.txt
#SBATCH --array=1
...
DIR="/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/ea_2_group_pmod_cov_age_sex"
