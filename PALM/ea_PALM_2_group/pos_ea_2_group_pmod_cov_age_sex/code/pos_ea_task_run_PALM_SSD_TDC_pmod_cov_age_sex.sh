...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/pos_ea_2_group_pmod_cov_age_sex/PALM_logs/PALM_SSD_TDC_pos_ea_task_pmod_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/ea_PALM_2_group/pos_ea_2_group_pmod_cov_age_sex/PALM_logs/PALM_SSD_TDC_pos_ea_task_pmod_cov_age_sex%jerr.txt
#SBATCH --array=1
