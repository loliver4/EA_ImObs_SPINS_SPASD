...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/ea_PALM_transdiag/ea_transdiag_NONpmod_simulation_cov_age_sex/PALM_logs/PALM_transdiag_ea_task_simulation_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/ea_PALM_transdiag/ea_transdiag_NONpmod_simulation_cov_age_sex/PALM_logs/PALM_transdiag_ea_task_simulation_cov_age_sex%jerr.txt
#SBATCH --array=1
...
DIR="/projects/imoxonemre/SPIN_ASD/ea_PALM_transdiag/ea_transdiag_NONpmod_simulation_cov_age_sex"
...
desmat="$DIR/con_design/transdiag_ea_task_design_simulation_cov_age_sex.csv"
conmat="$DIR/con_design/1_group_ea_task_contrast_simulation_cov_age_sex.csv"
