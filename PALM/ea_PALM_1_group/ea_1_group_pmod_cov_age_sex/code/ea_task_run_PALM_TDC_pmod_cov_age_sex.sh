...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/ea_PALM_1_group/ea_1_group_pmod_cov_age_sex/PALM_logs/PALM_TDC_ea_task_pmod_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/ea_PALM_1_group/ea_1_group_pmod_cov_age_sex/PALM_logs/PALM_TDC_ea_task_pmod_cov_age_sex%jerr.txt
#SBATCH --array=1
