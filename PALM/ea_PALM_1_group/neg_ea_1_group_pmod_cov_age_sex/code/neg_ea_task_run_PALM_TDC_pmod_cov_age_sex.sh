...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/ea_PALM_1_group/neg_ea_1_group_pmod_cov_age_sex/PALM_logs/PALM_TDC_neg_ea_task_pmod_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/ea_PALM_1_group/neg_ea_1_group_pmod_cov_age_sex/PALM_logs/PALM_TDC_neg_ea_task_pmod_cov_age_sex%jerr.txt
#SBATCH --array=1
...
DIR="/projects/imoxonemre/SPIN_ASD/ea_PALM_1_group/neg_ea_1_group_pmod_cov_age_sex"

sublistids="${DIR}/subids/TDC_sublist_ea.txt"
...
desmat="$DIR/con_design/TDC_ea_task_design_cov_age_sex.csv"
conmat="$DIR/con_design/1_group_ea_task_contrast_cov_age_sex.csv"
