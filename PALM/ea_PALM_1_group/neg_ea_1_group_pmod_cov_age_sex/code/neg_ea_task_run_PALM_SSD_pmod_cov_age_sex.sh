...
#SBATCH --output=/projects/imoxonemre/SPIN_ASD/ea_PALM_1_group/neg_ea_1_group_pmod_cov_age_sex/PALM_logs/PALM_SSD_neg_ea_task_pmod_cov_age_sex%j.txt
#SBATCH --error=/projects/imoxonemre/SPIN_ASD/ea_PALM_1_group/neg_ea_1_group_pmod_cov_age_sex/PALM_logs/PALM_SSD_neg_ea_task_pmod_cov_age_sex%jerr.txt
#SBATCH --array=1
...
sublistids="${DIR}/subids/SSD_sublist_ea.txt"
...
desmat="$DIR/con_design/SSD_ea_task_design_cov_age_sex.csv"
